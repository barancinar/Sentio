from tensorflow.keras.layers import Conv2D, BatchNormalization, MaxPool2D, Activation, GlobalAveragePooling2D, Dense, \
    Flatten
...
def get_base_model(image_shape):
    ...
    # Flatten the output of the GAP layer before feeding into Dense layer
    model.add(Flatten())
...
if __name__ == '__main__':
    ...
    mymodel.add(Dense(10, activation='softmax'))  # Assuming 10 classes
